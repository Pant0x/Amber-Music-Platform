  ...
  return (
    <div className="relative min-h-screen bg-black flex flex-col items-center justify-center overflow-hidden px-4 py-12">
      ...
      <div className="relative z-10 text-center mb-6 space-y-1.5">
        <h1 className="text-3xl font-extrabold text-white tracking-tight">Join Amber Music</h1>
        <p className="text-zinc-400 text-sm">Free forever. Your library follows you everywhere.</p>
      </div>
