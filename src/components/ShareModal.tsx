  ...
  const socials = [
    {
      ...
      link: (text: string) => `https://api.whatsapp.com/send?text=${encodeURIComponent(text)}`
    },
    {
      name: 'Facebook',
      color: '#1877F2',
      ...
      link: (text: string) => `https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(shareUrl)}`
    },
    {
      name: 'X',
      color: '#000000',
      ...
      link: (text: string) => `https://x.com/intent/tweet?text=${encodeURIComponent(text)}`
    },
    {
      name: 'Email',
      color: '#656565',
      ...
      link: (text: string) => `mailto:?subject=${encodeURIComponent('Shared Song')}&body=${encodeURIComponent(text)}`
    },
    {
      name: 'Reddit',
      color: '#FF4500',
      ...
      link: (text: string) => `https://www.reddit.com/submit?url=${encodeURIComponent(shareUrl)}&title=${encodeURIComponent(text)}`
    },
    {
      name: 'Pinterest',
      color: '#BD081C',
      ...
      link: (text: string) => `https://pinterest.com/pin/create/button/?url=${encodeURIComponent(shareUrl)}&media=${encodeURIComponent(shareTrack.thumbnailUrl || '')}&description=${encodeURIComponent(text)}`
    }
  ];
